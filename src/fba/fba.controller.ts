...
import { Post, Body,NotFoundException } from '@nestjs/common';
import { FbaService } from './fba.service';
import { FbaCalculationDTO } from './dto/fbaCalculation.dto';
...
export class FbaController {
  ...
  // }
  @Post()
  async CalculateFBA(@Body() body: FbaCalculationDTO) {
    return await this.fbaService.CalculateAllDetails(
      body.length,
      body.width,
      body.height,
      body.weight,
